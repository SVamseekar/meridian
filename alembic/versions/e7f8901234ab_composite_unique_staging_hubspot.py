...
def upgrade() -> None:
    ...
    # Remove global unique index on staging_hubspot_companies.hubspot_company_id if exists
    ...
    # Remove global unique index on staging_hubspot_deals.hubspot_deal_id if exists
